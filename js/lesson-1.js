...
// const minutes = Number(prompt("Введіть число:"));
...
// 10 // Напишіть функцію fizzBuzz(num), яка приймає число і перевіряє кожне число від 1 до num: // Якщо число ділитися без остачі на 3 - виводить в консоль 'fizz', // якщо ділиться без остачі на 5 - виводить в консоль 'buzz', // якщо ділиться без остачі і на 3, і на 5 - виводить в консоль 'fizzbuzz'.
...
//       console.log("buzz");
//     } else {
//       console.log(i); // можна прибрати, якщо не треба виводити інші числа
//     }
//   }
// }